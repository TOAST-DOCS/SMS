...
* [Console] Daily sending limit restrictions by country
  * Added the feature to restrict daily sending limits by country for international delivery.
  * You can set this in **Project Dashboard > Sending Settings > International SMS**.
