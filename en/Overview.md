...
- Provides replacement tags
    - You can send personalized SMS content for each recipient using replacement tags.
- Provides template features
    - Frequently used SMS can be registered as templates and used.

<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (no ko counterpart for Specifications) -->
