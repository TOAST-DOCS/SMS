...
## v3.0 API紹介 { #v30-api-overview }

<a id="changes-from-v24"></a>
### v2.4と異なる事項 { #changes-from-v24 }
...
### SMS送信リスト検索 { #list-delivery-of-short-sms }
...
### SMS送信単一検索 { #query-delivery-of-short-sms }
...
### 短文SMS国際送信コンバージョン { #convert-internation-delivery-of-short-sms }
...
### 長文MMS送信(添付ファイル含まず) { #send-long-mms-attachments-not-included }
...
### 長文MMS送信(添付ファイルを含む) { #send-mms-attached-file-included }
...
### 長文MMS送信リスト検索 { #list-delivery-of-long-mms-request }
...
### 長文MMS送信単一検索 { #query-single-delivery-of-long-mms }
...
## 認証用SMS(緊急) { #sms-for-authentication-emergency }
...
### 認証用SMS送信リスト検索 { #list-sms-delivery-for-authentication }
...
### 認証用SMS送信単一検索 { #query-single-sms-delivery-for-authentication }
...
### 認証SMS国際送信コンバージョン { #convert-authentication-sms-internaional-delivery }
...
## 広告文字 { #advertising-message }

<a id="send-advertising-sms"></a>
### 広告性SMS送信 { #send-advertising-sms }
...
### 広告SMS国際送信コンバージョン { #convert-advertising-sms-internaional-delivery }
...
## 結果アップデート基準メッセージ検索 { #search-messages-based-on-result-update }
...
### 大量送信受信者リスト検索 { #list-recipients-of-mass-delivery }
...
### 大量送信受信者リスト詳細検索 { #list-recipient-details-of-mass-delivery }
...
### タグ送信受信者リスト検索 { #list-recipients-of-tag-delivery }
...
### タグ送信受信者詳細検索 { #list-recipient-details-of-tagged-delivery }
...
### 添付ファイルアップロード { #upload-attached-files }
...
### テンプレート送信(本文の修正が必要ない場合) { #send-templates-requiring-no-body-updates }
...
### テンプレート送信(本文の修正が必要な場合) { #send-templates-requiring-body-updates }
...
### テンプレート単一検索 { #query-single-template }
...
## 080受信拒否サービス { #toll-free-opt-out-service }

<a id="retrieve-opt-out-list"></a>
### 受信拒否番号リスト検索 { #retrieve-opt-out-list }
...
### 受信拒否番号の単一検索 { #single-search-for-opt-out-number }
...
### 受信拒否対象者の登録 { #register-unsubscribers }
...
### 受信拒否対象者の検索 { #query-target-of-rejection }
...
### 登録された発信番号リスト検索API { #list-registered-sender-numbers-api }
...
### 統計検索 - イベント基盤 { #search-statistics---based-on-events }
...
### 統計検索 - リクエスト時間ベース { #statistics-search---based-on-request-time }
...
### 統計検索 - 国際送信 { #statistic-search---international-send }
...
### 予約送信リスト検索 { #list-scheduled-delivery }
...
### 予約送信詳細検索 { #query-detail-scheduled-delivery }
...
### 予約送信キャンセル { #cancel-scheduled-delivery }
...
### 予約送信キャンセルリクエストリスト検索 - 多重フィルタ { #list-request-of-scheduled-delivery-cancellation---multiple-filter }
...
## 送信結果ファイルダウンロード { #download-delivery-result-files }

<a id="request-for-creating-query-files"></a>
### 検索ファイル作成リクエスト { #request-for-creating-query-files }
...
### 送信結果ファイル作成リクエスト内訳検索 { #query-request-history-for-delivery-result-of-file-creation }
...
### 送信結果ファイルダウンロードリクエスト { #request-for-downloading-delivery-result-files }
...
### 携帯電話番号の登録 { #register-phone-number }
