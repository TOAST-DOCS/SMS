...
## Notification > SMS > API v2.2ガイド { #notification-sms-api-v22-guide }

<a id="v22-api-overview"></a>
## v2.2 API紹介 { #v22-api-overview }

<a id="changes-from-v-21"></a>
### v2.1からの変更事項 { #changes-from-v-21 }
...
<span style="color:red">ただし、本文には広告メッセージの必須文言が含まれている必要があります。</span>

080番号はコンソールの**[080受信拒否設定]**タブで確認できます。

広告メッセージの必須文言のルールは次のとおりです。
- 開始文言: `(광고)`
...
### タグ送信受信者リストの詳細照会 { #list-recipient-details-of-tagged-delivery }
...
### 統合統計照会 { #query-integrated-statistics }
