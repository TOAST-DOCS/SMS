...
### 広告メッセージ送信案内 { #guide-to-sending-advertising-messages }
[[情報通信網利用促進及び情報保護等に関する法律](https://www.law.go.kr/%EB%B2%95%EB%A0%B9/%EC%A0%95%EB%B3%B4%ED%86%B5%EC%8B%A0%EB%A7%9D%EC%9D%B4%EC%9A%A9%EC%B4%89%EC%A7%84%EB%B0%8F%EC%A0%95%EB%B3%B4%EB%B3%B4%ED%98%B8%EB%93%B1%EC%97%90%EA%B4%80%ED%95%9C%EB%B2%95%EB%A5%A0)] 第50条に基づき、営利目的の広告性情報を送信する際は、受信者の明示的な事前同意を得る必要があり、送信表示の義務事項を必ず遵守する必要があります。
関連法律に違反した場合、違反内容に応じて刑事処罰または過料が科される可能性がありますのでご注意ください。
...
* メッセージの発信者情報として「業者名またはサービス名」と「連絡先」を表記します
    * 発信番号と連絡先が同じ場合、連絡先の省略が可能です
* メッセージの末尾に無料受信拒否 080 番号を表記します
...
|---|---|---|
| SMS | 25 時間 | 再試行しません。受信失敗結果の更新（結果コード: 2000） |
| LMS | 80 時間 | 再試行しません。受信失敗結果の更新（結果コード: 2000） |
| MMS | 80 時間 | 再試行しません。受信失敗結果の更新（結果コード: 2000） |
