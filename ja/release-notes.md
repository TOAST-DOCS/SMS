...
#### 機能追加
* [Console] 国別の1日送信限度制限
  * 国際送信時に国別に1日の送信限度を制限できる機能を追加しました。
...
* [Console] メッセージ送信履歴バックアップ結果通知の追加
...
* [API] メッセージ単件照会バグ修正
    * メッセージ単件照会時、照会結果がタイプを区別せずに表示されるバグを修正しました。
...
* [API]認証用メッセージの送信時、認証文言の有効性チェックを強化
    ...
    * 詳細は[[APIガイド](./api-guide/#send-sms-for-authentication)]を参照してください。
...
* [API] 予約送信リスト照会/キャンセル API 追加
    * 予約送信リストを照会してキャンセルできる API が追加されました。
