...
* [Console/API]国際SMS送信コンバージョン機能追加
    ...
    * サービス設定 > 国際SMS送信設定タブにコンバージョン率によるブロックと通知設定を追加しました。
        * 国際SMS送信設定画面にコンバージョン率によるブロックと通知機能が追加されました。
        * コンバージョン率によるブロックを許可する国の設定機能が追加されました。
    * 詳細については、 [[国際SMS送信ポリシー > コンバージョン率による遮断機能使用及びコンバージョン率管理](./international-sending-policy/#sms_2)]を参照してください。
* [Console]コンバージョン率によるブロックWebフックを追加
    * コンバージョン率によるブロックが発生した場合、 Webフックを受け取ることができます。
