...
* [Console/API] 국제 발송 concat 제공
    ...
    * 자세한 사항은 서비스 정책의 [[과금 정책](./service-policy/#_12)]를 참고하시기 바랍니다.
