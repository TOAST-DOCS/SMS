...
* [Console/API] 국제 SMS 발송 전환 기능 추가
    ...
    * 서비스 설정 > 국제 SMS 발송 설정 탭에 전환율에 의한 차단 및 알림 설정 추가 
        * 국제 SMS 발송 설정 화면에 전환율에 의한 차단 및 알림 기능이 추가되었습니다.
        * 전환율에 의한 차단을 허용할 국가 설정 기능이 추가되었습니다.
    * 자세한 사항은 [[국제 SMS 발송 정책 > 전환율에 의한 차단 기능 사용 및 전환율 관리](./international-sending-policy)]을 참고하시기 바랍니다.
* [Console] 전환율에 의한 차단 웹훅 추가
    * 전환율에 의한 차단 발생 시 웹훅을 받을 수 있습니다.
