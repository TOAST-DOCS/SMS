...
#### 기능 추가
* [Console] 국가별 1일 발송 한도 제한
  * 국제 발송 시 국가별로 1일 발송 한도를 제한할 수 있는 기능이 추가되었습니다.
  * **프로젝트 대시보드 > 발송 설정 > 국제 SMS**에서 설정할 수 있습니다.

<a id="march-24-2026"></a>
### 2026. 3. 24. { #march-24-2026 }
<a id="march-24-2026-added-features"></a>
#### 기능 추가
* [Console] 메시지 발송 내역 백업 결과 알림 추가
...
#### 기능 추가
* [API] 080 수신 거부 번호 조회 API 추가
    * 080 수신 거부 번호를 조회할 수 있는 API가 추가되었습니다.
    * 자세한 사항은 [[API v3.0 가이드 > 080 수신 거부 서비스](./api-guide/#080)]을 참고하시기 바랍니다.

<a id="october-28-2025"></a>
### 2025. 10. 28. { #october-28-2025 }
<a id="october-28-2025-feature-updates"></a>
#### 기능 개선/변경
* [Console/API] 광고 발송 시 080 수신 거부 번호 유효성 검증 로직 완화
  * 광고 발송 시 080 수신 거부 번호에 '-'을 중간에 삽입하여도 정상적으로 발송이 되도록 변경되었습니다.
* [ETC] 알림 관리 - 월 발송량 제한 알림 추가
    * 설정된 월 발송량 제한 값의 70%, 90%, 100%에 도달할 때마다 자동으로 알림을 받을 수 있습니다.
    * **프로젝트 대시보드 > 알림 관리**에서 설정 가능합니다.

<a id="october-28-2025-bug-fixes"></a>
#### 버그 수정
* [API] 통계 조회 버그 수정
  * 통계 조회 시 데이터 검색 범위를 좁게 설정한 경우 데이터가 2배로 조회되는 버그가 수정되었습니다.

<a id="june-24-2025"></a>
### 2025. 06. 24. { #june-24-2025 }
<a id="june-24-2025-feature-updates"></a>
#### 기능 개선/변경
* [Console/API] 국제 발송 통계 개선
    * 국제 발송 통계의 발송 건수 이벤트 수집 시간 기준이 발송 성공 시간 기준으로 변경되었습니다.
* [ETC] Cloud Monitoring 지표 조회 추가
    * Cloud Monitoring 서비스에서 발송 실패, 수신 성공, 수신 실패에 대한 지표 조회가 가능하도록 추가되었습니다.
...
* [API] 인증용 메시지 발송 시 인증 문구 유효성 검사 강화
    ...
    * 자세한 사항은 [[API 가이드](./api-guide/#send-sms-for-authentication)] 참고하시기 바랍니다.
