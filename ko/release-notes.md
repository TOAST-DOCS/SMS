...
### 2020. 09. 22.
### 기능 개선/변경
* [API] 수신 시간 기준 결과 업데이트 조회 API 버그 수정
    * 수신 시간 기준 결과 업데이트 조회 시 발송 일시와 수신 일시의 기준 월이 다른 경우 조회가 안 되는 문제가 수정되었습니다.
* [Console] 080 수신 거부 해지 기한 변경
    * 080 수신 거부 해지는 승인되고 난 뒤 24시간이 지난 뒤부터 가능하도록 수정되었습니다.
* [Console] 080 수신 거부 Webhook 기능 추가
    * 080 수신 거부에 의해 수신 거부한 휴대폰 번호를 Webhook으로 받을 수 있도록 기능이 추가되었습니다. 
