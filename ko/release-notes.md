...
### 2020. 07. 28.
### 기능 개선/변경
* [Console/API] 이메일 형식의 템플릿 아이디 생성 이슈
    * 이메일 형식으로 템플릿 아이디를 생성하는 경우 조회, 수정, 삭제가 안되는 문제를 수정하였습니다.
* [Console/API] 간헐적인 국제 발송 길이 체크 에러 이슈
    * 간헐적으로 국제 발송 시 길이 체크를 잘못하여 발송 실패 처리되는 문제가 수정되었습니다.
