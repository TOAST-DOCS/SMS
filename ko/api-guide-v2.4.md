...
- 시작 문구: `(광고)`
- 마지막 문구: `무료수신거부 {080수신거부번호}` 또는 `무료거부 {080수신거부번호}` 
  - 해당 문구에는 공백이 포함될 수 있습니다.
  - 080 수신 거부 번호 사이에는 '-'이 포함될 수 있습니다.
