...
분할 발송 사용시, **분할 횟수**와 **발송 간격**을 지정하여 발송을 나누어서 진행할 수 있습니다.
...
| 발신 번호 종류 | 인증 방법 | 필요 서류 |
| --- | --- | --- |
| 대표자 번호, 당사 자체 번호 | 서류 인증 | 통신서비스 이용증명원 | 
| 임직원 번호 | 서류 인증 | 통신서비스 이용증명원, 임직원 재직증명서 |
| 타사 번호 | 서류 인증 | 통신서비스 이용증명원, 이용승낙서, (타사)사업자등록증, 사업자와 타사 간 관계 확인 문서(계약서 등) |
...
1. 발신 번호를 등록하기 전에 본인 인증을 하지 않은 경우 본인 인증 절차를 진행합니다.
    * 2022년 3월 2일 이전 등록된 계정의 경우에도 본인 인증 절차를 진행해야 합니다.
...
8. 본인 인증 절차가 완료되면 계정에 등록된 메일로 승인 결과가 전송됩니다.
