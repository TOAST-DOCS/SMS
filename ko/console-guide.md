...
* SMS 서비스를 이용하기 위해서는 본인 인증 절차가 필수 입니다. 본인 인증은 기본적으로 휴대폰 본인 인증과 추가로 회원 유형에 따라 서류 심사가 필요합니다.
    * 본인 인증을 하지 않으면 발신 번호 사전 등록 탭 이외에는 모두 비활성화됩니다.
...
| IAM 맴버 | 휴대폰 본인 인증 | 사업자등록증, 재직증명서 |
| 개인 | 휴대폰 본인 인증 | - |


### 본인 인증 절차
1. **발신 번호 사전 등록** 탭을 선택합니다.
2. **휴대폰 본인 인증 및 필요 서류 첨부하기** 버튼 클릭하여 절차 시작합니다.
3. 개인정보 수집 이용 동의 확인 및 동의합니다.
4. 휴대폰 문자 본인 인증 또는 간편 본인 확인 인증을 통해 본인 인증 절차 진행합니다.
5. 필요한 서류가 있는 경우 서류 첨부하여 등록합니다.
6. 운영자 검수 및 승인 절차를 대기합니다. 
7. 완료가 된 경우 계정에 등록된 메일로 결과가 전송됩니다.

## 발신 번호 사전등록

#### 발신번호 사전등록제 시행
* 전기통신사업법 제84조에 따라 발신번호 등록 시 발신번호에 대한 명의자 인증이 필요합니다. 
* 명의자 인증은 회원과 발신번호 종류 따라 인증 방법과 필요한 서류가 결정됩니다.
...
| 발신번호 종류 | 인증 방법 | 필요 서류 |
| --- | --- | --- |
| 대표자 번호, 당사 자체 번호 | 서류 인증 | 통신서비스 이용증명원 | 
| 임직원 번호 | 서류 인증 | 통신서비스 이용증명원, 임직원 재직증명서 |
| 타사 번호 | 서류 인증 | 통신서비스 이용증명원, 이용승낙서, (타사)사업자등록증, 사업자와 타사간 관계확인 문서(계약서 등) |
| 타인 번호 | 서류 인증 | 통신서비스 이용증명원, 이용승낙서 |
...
| 발신번호 종류 | 인증 방법 | 필요 서류 |
| --- | --- | --- |
| 본인 번호(휴대폰 번호) | 휴대폰 본인 인증 또는 서류 인증 | 통신서비스 이용증명원(서류 인증 시) | 
| 본인 번호(일반 번호) | 서류 인증 | 통신서비스 이용증명원 |
| 기업/타인 번호 | 등록 불가 | - |
...
1. 발신 번호를 등록하기 전에 본인 인증을 하지 않은 경우 본인 인증 절차를 진행합니다.
    * 이는 2022년 3월 2일 이전 등록된 계정도 포함입니다.
2. 본인 인증으로 등록이 가능한 경우에는 **발신번호 등록 및 휴대폰 본인 인증하기** 버튼을 아닌 경우 **발신 번호 등록 및 서류 인증하기** 버튼을 눌러 등록 절차를 시작합니다.
3. 개인정보 수집 이용 동의 확인 및 동의합니다.
4. 등록에 필요한 발신 번호 유형을 선택합니다. (본인 번호, 대표자 번호, 임직원 번호 등등)
5. 등록할 발신 번호를 입력합니다.
6. 등록할 번호에 맞는 서류를 첨부하여 등록합니다.
7. 운영자 검수 및 승인 절차를 대기합니다. 
8. 완료가 된 경우 계정에 등록된 메일로 결과가 전송됩니다.
