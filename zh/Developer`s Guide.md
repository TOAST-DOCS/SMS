...
이전 버전보기 :   <select onchange="location.href=this.value"><option selected value="/zh/Notification/SMS/zh/Developer%60s%20Guide/">API v2.0</option><option value="/zh/Notification/SMS/zh/Developer%60s%20Guide_v1/">API v1.0</option></select>
