...
### 2018.10.23
#### 기능 개선
* [Console/API] Emoji 발송 요청 시 시스템 에러가 아닌 정의된 에러로 응답되도록 수정
    * Console에서 Emoji 포함된 내용 발송 시, 전송할 수 없다는 알럿 창이 노출됩니다.
    * API에서 Emoji 포함된 내용 발송 시, -2023 에러 코드로 응답됩니다.
...
#### 버그 수정
* [API] 잘못된 에러 코드 응답 개선
    * 문자 발송 요청 시, 요청 필드에 이미 지난 시간을 입력하는 경우 -2021 에러로 응답하지 않고 -2021 에러로 응답하도록 수정되었습니다.
